...
Streams frames from the camera, tracks object IDs over time, computes movement velocities,
...
def main():
    ...
    tracker = ObjectTracker(iou_threshold=0.2, max_center_distance=150.0)
    history = TrackHistoryManager(history_length=30)

    print("2. Running 15-frame tracking sequence on camera feed...")
    last_frame = None
