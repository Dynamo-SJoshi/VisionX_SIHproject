...
Evidence is deliberately separated from ActionEvent.

ActionEvent:
    describes what AI believes happened.

EvidenceBundle:
    describes the evidence supporting that belief/decision.
"""
...
class EvidenceItem(SchemaBase):
    ...
    video_timestamp_seconds: Optional[float] = Field(
        default=None,
        ge=0.0,
    )
